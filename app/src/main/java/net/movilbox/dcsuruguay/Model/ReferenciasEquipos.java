...
public class ReferenciasEquipos implements Serializable {
    ...
    private List<Referencia_equipo> referenciaLis;
    ...
    public List<Referencia_equipo> getReferenciaLis() {
        return referenciaLis;
    }

    public void setReferenciaLis(List<Referencia_equipo> referenciaLis) {
