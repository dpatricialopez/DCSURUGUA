...
public class ControllerTerritorio {
    ...
    public ControllerTerritorio(Context context) {
    ...
    public boolean insertTerritorio(EntLisSincronizar data) {
        ...
        try {
            ...
            database.insert("territorio", null, values);
    ...
    public List<EntEstandar> getCircuito() {

        List<EntEstandar> entEstandars = new ArrayList<>();
        String sql = "SELECT 0 AS id, 'SELECCIONAR' AS descripcion UNION SELECT id, descripcion FROM territorio";
