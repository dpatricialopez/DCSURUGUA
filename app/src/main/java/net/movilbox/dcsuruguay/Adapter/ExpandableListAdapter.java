...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<EntEstandar>> expandableListDetail) {
    ...
    public View getChildView(int listPosition, final int expandedListPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        txt_referencia.setText(String.format("Serie: %s", expandedListText.getDescripcion()));
