...
import net.movilbox.dcsuruguay.Activity.ActListCatalogoDirecta;
...
public class AdapterRecyclerCatalogoDirecta extends RecyclerView.Adapter<RowViewHolderCatalog> {
    ...
    public AdapterRecyclerCatalogoDirecta(Activity context, List<EntCatalogo> responseHomeList) {
        super();
    ...
    public void onBindViewHolder(final RowViewHolderCatalog holder, final int position) {
        ...
        holder.btnpedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ActListCatalogoDirecta.class);
